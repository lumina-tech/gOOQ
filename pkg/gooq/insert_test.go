...
var insertTestCases = []TestCase{
	{
		...
		"INSERT INTO table1 (table1.column1) VALUES ($1)",
	},
	{
		InsertInto(Table1).Set(Table1.Column1, "foo").Set(Table1.Column2, "bar"),
		"INSERT INTO table1 (table1.column1, table1.column2) VALUES ($1, $2)",
	},
	{
		InsertInto(Table1).
			Values("1", "2", 3, 4).
	...
	},
	{
		InsertInto(Table1).
			...
			Values("1", "2", 3, 4).
			Values("2", "3", 4, 5),
		"INSERT INTO table1 (table1.column1, table1.column2, table1.column3, table1.column4) VALUES ($1, $2, $3, $4) ($5, $6, $7, $8)",
	},
	{
	...
	},
	{
		...
		"INSERT INTO table1 (table1.column1) VALUES ($1) ON CONFLICT DO NOTHING",
	},
	{
		InsertInto(Table1).Set(Table1.Column1, "foo").Returning(Table1.Column1),
		"INSERT INTO table1 (table1.column1) VALUES ($1) RETURNING table1.column1",
	},
	{
		InsertInto(Table1).
		...
		"INSERT INTO table1 (table1.column1, table1.column2) VALUES ($1, $2) ON CONFLICT DO UPDATE (table1.column1) SET table1.column2 = $3",
	},
	{
		InsertInto(Table1).
			Set(Table1.Column1, "foo").Set(Table1.Column2, "bar").
		...
		"INSERT INTO table1 (table1.column1, table1.column2) VALUES ($1, $2) ON CONFLICT DO UPDATE (table1.column1) SET table1.column2 = EXCLUDED.column2",
	},
}
