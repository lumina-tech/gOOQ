...
var selectTestCases = []TestCase{
	...
	},
	{
		...
		"SELECT table1.column1 FILTER (WHERE table1.column2 = $1) FROM table1",
	},
	{
	...
	},
	{
		...
		"SELECT table1.column3 + $1 FROM table1",
	},
	{
	...
	},
	{
		...
		"SELECT table1.column3 + table1.column4 FROM table1",
	},
	{
	...
	},
	{
		...
		"SELECT table1.column3 / table1.column4 AS result FROM table1",
	},
	{
		...
		ExpectedStmt: "SELECT table1.column1 FROM table1 WHERE table1.column2 = $1 AND table1.column2 = $2 UNION (SELECT table1.column1 FROM table1 WHERE table1.column2 = $3 AND table1.column2 = $4) ORDER BY column2 ASC",
	},
	{
		Select().From(Table1).OrderBy(Table1.Column1.Asc()),
		"SELECT * FROM table1 ORDER BY table1.column1 ASC",
	},
	{
		Select().From(Table1).OrderBy(Table1.Column1.Desc()),
		"SELECT * FROM table1 ORDER BY table1.column1 DESC",
	},
	{
		Select().From(Table1).GroupBy(Table1.Column1),
		"SELECT * FROM table1 GROUP BY table1.column1",
	},
	{
		Select(Table1.Column1.Filter(Table1.Column2.Eq(String("foo")))).From(Table1),
		"SELECT table1.column1 FILTER (WHERE table1.column2 = $1) FROM table1",
	},
	{
		...
		"SELECT COALESCE(table1.column1 FILTER (WHERE table1.column2 = $1), $2) AS total FROM table1",
	},
	{
