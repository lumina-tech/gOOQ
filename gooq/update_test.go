...
var updateTestCases = []TestCase{
	{
		...
		"UPDATE table1 SET table1.column1 = $1",
	},
	{
		Update(Table1).Set(Table1.Column3, Table1.Column4.Add(Int64(10))),
		"UPDATE table1 SET table1.column3 = table1.column4 + $1",
	},
	{
	...
	},
	{
		...
		"UPDATE table1 SET table1.column1 = $1 WHERE table1.column2 = $2",
	},
	{
		Update(Table1).Set(Table1.Column1, Table2.Column1).
			From(Table2).On(Table1.Column2.Eq(Table2.Column2)),
		"UPDATE table1 SET table1.column1 = table2.column1 FROM table2 WHERE table1.column2 = table2.column2",
	},
	{
		Update(Table1).Set(Table1.Column1, Table2.Column1).
			From(Select().From(Table2)).On(Table1.Column2.Eq(Table2.Column2)),
		"UPDATE table1 SET table1.column1 = table2.column1 FROM (SELECT * FROM table2) WHERE table1.column2 = table2.column2",
	},
	{
		Update(Table1).Set(Table1.Column1, "10").OnConflictDoNothing(),
		"UPDATE table1 SET table1.column1 = $1 ON CONFLICT DO NOTHING",
	},
	{
		Update(Table1).Set(Table1.Column1, "10").Returning(Table1.Column1),
		"UPDATE table1 SET table1.column1 = $1 RETURNING table1.column1",
	},
}
